...
export class AttendanceController {
  ...
  public async checkOutTimeAttendance(@QueryParam("id") id: any, @QueryParam("date") date: any, @Body() req: any, @Res() res: Response): Promise<Response> {
    let data = await this.attendanceService.postOutTimeAttendance(id, date, req);
    console.log(data);
  ...
  @Get("/date/:date")
  public async getAttendanceByDate(@Param("date") date: Date, @Res() res: Response): Promise<Response> {
