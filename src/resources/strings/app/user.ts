...
const ENTER_VALID_DOB="Please enter valid date of birth"

export {ENTER_VALID_DOB, INVALID_PHONE, EMPTY_FIRST_NAME, INVALID_FIRST_NAME, EMPTY_LAST_NAME, INVALID_LAST_NAME, EMPTY_EMAIL, INVALID_EMAIL, EMPTY_PASSWORD, INVALID_PASSWORD, INVALID_PROFILE_IMAGE_URL, USER_NOT_CREATED, USER_NOT_FOUND, ROLE_MISSING, USER_CREATE_FAILED };
